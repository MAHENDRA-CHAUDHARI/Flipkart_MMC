...
public class HTMLReportGenerator2 {
	...
	public HTMLReportGenerator2(String HTMLFilePath,String UserName) throws UnknownHostException
	{
		
		TestSuiteStart(HTMLFilePath,UserName);
		isShowImage=false;
	}
	public HTMLReportGenerator2(String HTMLFilePath,String UserName,String ImageFolderPath) throws UnknownHostException
	{
		isShowImage=true;
